...
?>
        ...
        <head>
            ...
            <title>Espace Personel | Opérateur Rapido | Courses</title>
        ...
        <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link actif" href="/operateur/">Courses</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="/operateur/encours/">Courses en cours</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="card mb-5 ">
                        ...
                        <div class="card-body">
                            <table class="table table-hover">
                                ...
                                $result = $opts->allCoursesOperateur($id);
            ...
            <footer class=" mon-bg-5 text-white p-2">
                <div class="container">
                    <div class="row">

                        <div class="col">
                            <div class="" style="text-align: right">
                            <a href="/assets/includes/deconnect.php" class="logout-button">Déconnexion</a>
                ...
                <div class="courseModal-content mx-auto p-1">
                    ...
                    <div class="container py-3 ">
                        ...
                        <form action="" method="post" class=" p-3 laforme">
                            ...
                            <div class="row mb-3 p-0 ">
                                <div class="col-12 col-sm-6 p-3">
                                    <input type="reset" value="Annuler" class=" w-100 border-0 py-3 bg-warning rounded-2 ">
                                </div>
                                <div class="col-12 col-sm-6 p-3">
            ...
            <script src="/assets/js/addCourseAsOperateur.js"></script>
        </body>
