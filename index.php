        ...
        <div class="container-sm pt-5 pb-5">
            <div class="row">
                ...
                " class="d-block mx-auto logo-rapido">
                        <h2 class="text-center mx-5 mb-3 text-light p-2 pb-3 border-bottom ">Welcome!!!</h2>
                        <form action="assets/includes/loginControl.php" method="post">
                            ...
                            <div class="row align-items-center form-group pb-3 pt-3 mx-5">
                                <div class="col-4 p-0">
                                    <label for="telephone" class="text-light h6">Phone :</label>
                                </div>
                                <div class="col-8 p-0">
                                    <?php
                                    if (isset($_SESSION['tel']) && $_SESSION['tel'] != "") {
                                        echo '<input type="tel" id="telephone" name="telephone" class="form-control text-center" placeholder="EX :70 00 00 00" pattern="[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}" title="Veuillez saisir un numéro de téléphone valide (ex: 70 00 00 00)" value="' . $_SESSION['tel'] . '" required>';
                                    } else {
                                        echo '<input type="tel" id="telephone" name="telephone" class="form-control text-center" placeholder="EX : 70 00 00 00" pattern="[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}" title="Veuillez saisir un numéro de téléphone valide (ex: 70 00 00 00)" required>';
                                    }
                                    ?>
                                </div>
                            </div>
                            <div class="row align-items-center form-group pb-4 pt-3 mx-5 border-bottom">
                                <div class="col-4 p-0">
                                    <label for="password" class="text-light h6">Passwords :</label>
                                </div>
                                <div class="col-8 p-0">
                            ...
                            <div class="row form-group px-4 pb-2 m-1 mb-0">
                                ...
                                <div class="col-8 d-flex align-items-end justify-content-end px-4">
                                    <button type="submit" class="btn btn-primary btn-block mt-3 d-block mb-lg-auto" id="r">To log</button>
                                </div>
                            </div>
                        </form>
                    </div>
