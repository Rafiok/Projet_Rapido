...
?>
        ...
        <body>
                                ...
                                <table class="table table-hover">
                                    ...
                                    foreach ($result as $a) {
                                        ...
                                        if (debutTbody($i) == 1) { ?>
                                            <tbody class="tbody">
                                            <?php } ?>
                                            <tr class="text-center border uneLigne" id="tr<?php echo $a['statut']; ?>">
                                                    ...
                                                    if ($a['statut'] == 2) { ?>
                                                        <select name="chauf" id="../../assets/includes/attributChauffeur.php?id1=<?php echo $a['course_id']; ?>&id2=" class=" p-1 border selection" disabled>
                                                            ...
                                                            if ($a['chauffeur_id'] != null) { ?>
                                                                ...
                                                                <option value="-1" class=" px-1 py-2 ">aucun</option>
                    ...
                    <div class="image-formulaire">
                        ...
                        <div class="formulaire container" id="premier-index">
                            ...
                            <form method="post" class="formemaj">
                                ...
                                <input type="telephone" name="telephone" id="telephone" placeholder="ex: 91195931">
            ...
            <script src="/assets/js/chauffeur_Admin.js"></script>
        </body>
