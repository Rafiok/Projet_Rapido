...
?>
        ...
        <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link actif" href="/chauffeur/">Courses</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="/chauffeur/history/">Historique</a>
                                </li>
                            </ul>
                            ...
                            <table class="table table-hover">
                                <thead class="table-dark w-100">
                                    <tr class="text-center border border-black">
                                        ...
                                        <th class=" p-2 statut">Terminer</th>
                                ...
                                $result = $opts->allCoursesOfChauffeur($id);
                                ...
                                foreach ($result as $a) {
                                    ...
                                    if (debutTbody($i) == 1) { ?>
                                        <tbody class="tbody">
                                        <?php } ?>
                                        <form action="/assets/includes/terminerCourse.php" method="post">
            ...
            <footer class="mon-bg-5 p-2 text-white">
                <div class="container">
                    <div class="row">
                        <div class="col">
